      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-16 space-y-14 sm:space-y-20">
        ...
        <section className="text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-3">
              ...
              <a
                href="http://kilo.ai/discord"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-neutral-700 bg-neutral-900 text-neutral-200 hover:border-indigo-500/50 hover:bg-indigo-950/20 hover:text-indigo-300 transition-all duration-150 text-sm font-medium"
              >
                {/* Discord */}
                <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="currentColor">
